    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Center(
            child: Container(
              height: dialogContext.h(fromUmrah ? 450 : 400),
              ...
              child: Column(
                children: [
                  Expanded(
                    child: Padding(
                      padding: dialogContext.edgeInsets(top: 28, left: 16, right: 16),
                      child: Column(
                        ...
                        children: [
                          ...
                          Expanded(child: CustomImage(margin: dialogContext.edgeInsets(vertical: 16), path: fromUmrah ? 'assets/png/home/green_light.png' : 'assets/png/home/safa_marwa.png', imageType: ImageType.png, fit: BoxFit.fitWidth)),
                        ],
                      ),
                    ),
                  ),
                  CButton(margin: dialogContext.edgeInsets(left: 16, right: 16, bottom: 20), height: 45, title: LocaleKeys.yes_i_have_reached.tr(), onTap: () => Navigator.pop(dialogContext, true), style: CTextStyle.w400(fontSize: 13, color: Colors.white)),
                ],
              ),
            ),
          ),
