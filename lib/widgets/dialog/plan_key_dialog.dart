            ...
            Center(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    RepaintBoundary(child: CTextField(margin: EdgeInsets.only(top: screenSize.height * 0.04, bottom: screenSize.height * 0.03), controller: controller, keyboardType: TextInputType.text, labelText: LocaleKeys.key.tr())),
                    CButton(
