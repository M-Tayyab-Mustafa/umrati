        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              PaymentButton(margin: EdgeInsets.zero, onTap: ref.read(subscriptionProvider.notifier).onJazzCashTap, title: 'Jazz Cash'),
              PaymentButton(margin: EdgeInsets.symmetric(vertical: 16), onTap: ref.read(subscriptionProvider.notifier).onEasyPaisaTap, title: 'Easy Paisa'),
            ],
          ),
        ),
      ),
