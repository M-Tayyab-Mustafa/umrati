    ...
    switch (provider.tawafCircleCount) {
      case 7:
        return provider.userActivityType == UserActivityType.tawaf
            ? Padding(padding: SizeConfig.only(bottom: kToolbarHeight), child: Consumer(builder: (context, ref, child) => CButton(onTap: provider.moveToSafaMarwa, title: LocaleKeys.go_to_home_screen.tr(), titleWithIcon: true)))
            : Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                CheckBoxCard(
