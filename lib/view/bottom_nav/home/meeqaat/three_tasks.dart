...
class _MeeqaatThreeTasksPageState extends ConsumerState<MeeqaatThreeTasksPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Background(
      ...
      titleMargin: context.edgeInsets(vertical: kToolbarHeight * 0.4),
      showEmblem: false,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Padding(padding: context.edgeInsets(vertical: 8), child: Center(child: Text(LocaleKeys.these_3_tasks_can_be_done_even_before_meeqaat.tr(), style: CTextStyle.w400(fontSize: 14, color: CColors.primary)))),
            CheckBoxCard(margin: context.edgeInsets(vertical: 20), title: LocaleKeys.two_nafl_prayer.tr(), isSelected: provider.isTwoNafiPrayersChecked, onTap: provider.updateTwoNafiPrayersChecked),
            ...
            CheckBoxCard(margin: context.edgeInsets(vertical: 20), title: LocaleKeys.talbiyah.tr(), isSelected: provider.isTalbiyahChecked, onTap: provider.updateTalbiyahChecked),
            CButton(isLoading: provider.isLoading, onTap: provider.tasksDone, margin: context.edgeInsets(top: 40), title: LocaleKeys.tasks_done.tr(), titleWithIcon: true),
          ],
        ),
      ),
    );
