...
import '../../controller/umera/completed_provider.dart';
...
class UmraCompleted extends StatefulWidget {
  const UmraCompleted({super.key});

  @override
  State<UmraCompleted> createState() => _UmraCompletedState();
}

class _UmraCompletedState extends State<UmraCompleted> {
  @override
