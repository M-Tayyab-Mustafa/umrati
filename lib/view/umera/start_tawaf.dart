...
class StartTawafPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Background(
      ...
      margin: provider.circleCount != 7 ? null : EdgeInsets.only(top: kToolbarHeight, left: 30, right: 30),
      child: Column(
        children: [
                          ...
                          child: SizedBox(
                            ...
                            child: Stack(
                              children: [
                                ...
                                Center(
                                  child: Padding(padding: const EdgeInsets.only(bottom: 3), child: Text(provider.circleCount.toString(), style: CTextStyle.w900(fontSize: 16, color: CColors.primary))),
                                ),
                              ],
                            ),
                          ),
          ...
          if (provider.circleCount < 7)
            ...
            Column(
              ...
              children: [
                ...
                CButton(margin: EdgeInsets.symmetric(vertical: 30), onTap: () => provider.moveToSafaMarwa(context: context), titleWithIcon: true, title: LocaleKeys.continued.tr()),
              ],
            ),
        ],
      ),
