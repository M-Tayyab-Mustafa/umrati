...
class SocialLoginService {
  ...
  Future<void> signInWithApple(BuildContext context, WidgetRef ref) async {
    try {
      ...
      await linkWithCredentials(context: context, ref: ref, credential: oauthCredential, email: appleCredential.email ?? '');
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<void> linkWithCredentials({required BuildContext context, required WidgetRef ref, required AuthCredential credential, required String email}) async {
    try {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        await _signWithCredentials(context: context, ref: ref, credential: credential);
      }
  ...
  Future<void> _signWithCredentials({required BuildContext context, required WidgetRef ref, required AuthCredential credential}) async {
    try {
