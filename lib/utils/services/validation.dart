...
String? validatePhoneNumber(String phone, String countryCode) {
  final isValid = PhoneNumberUtil.instance.isValidNumber(PhoneNumberUtil.instance.parse(phone, countryCode));
  if (!isValid) return '$phone ${LocaleKeys.not_valid_number.tr()}';
  return null;
}
